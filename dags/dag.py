...
# This is a code that uses beatifulsoup to strapped the amazon webpage and the data form the books.
######################
headers = {
...
def insert_book_data_into_postgres(ti):
    ...
    postgres_hook = PostgresHook(postgres_conn_id='books_connection') # conenction seup already in airflow connections
    insert_query = """
    INSERT INTO books (title, authors, price, rating) 
    VALUES (%s, %s, %s, %s)
    """ 
    for book in book_data:  # Here we are just inserting the values, the schema and table shoudl be created already.
...
fetch_book_data_task = PythonOperator(
    ...
    python_callable=get_amazon_data_books, # function that we declared before
